...
namespace Clientes.classes
{
    public class Cliente
    {
        ...
        public string cadastrar()
        {
            ...
            FileInfo arquivo = new FileInfo(@"c:\Caroline\cliente.xlsx");
            if (arquivo.Exists)
            {
                ex.Visible = true;//Abrir o microsoft excel
                //Vamos abrir o arquivo existente
                ex.Workbooks.Open(@"c:\Caroline\cliente.xlsx");
                /*
                Vamos fazer um laço com for para percorrer as linhas do excel 
                e encontrar uma linha vazia. Quando encontrar essa linha ele
                deve parar e escrever a linha com os dados do cliente
                 */
                for (int x = 3; x <= 100; x++)
                {
                ...
                //Vamos salvar o arquivo de excel
            ...
            else
            {
                ...
                ex.Workbooks.Add();//adicionar uma planilha em branco
                                   /*
                                   Vamos montar o cabeçalho das colunas na linha 1
                                    */
                ...
                ex.ActiveWorkbook.SaveAs(@"c:\Caroline\cliente.xlsx");
                ex.Quit();
            }
        ...
        public string[,] listar()
        {
            ...
            excel.Visible = true;
            excel.Workbooks.Open(@"c:\Caroline\cliente.xlsx");
